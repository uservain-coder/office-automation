...
python scripts/file_rename.py <参数>
```
...
```bash
python scripts/file_rename.py rename --input ../examples/file_rename/input --rule prefix --prefix 资料
```
...
```bash
python scripts/file_rename.py rename --input ../examples/file_rename/input --rule prefix --prefix 资料 --yes
```
...
```bash
python scripts/file_rename.py rename --input ../examples/file_rename/input --rule date
```
...
```bash
python scripts/file_rename.py rename --input ../examples/file_rename/input --rule date --yes
```
...
```bash
# 正则改名示例（先预览，确认后加 --yes 执行）
python scripts/file_rename.py rename \
    --input ../examples/file_rename/input \
    --rule regex --pattern "IMG" --repl "旅行"
```
...
python scripts/file_rename.py rename \
    --input ../examples/file_rename/input \
    --rule regex --pattern "IMG" --repl "旅行" --yes
```
...
```bash
# 按类型自动分类（预览后加 --yes）
python scripts/file_rename.py classify \
    --input ../examples/file_rename/input
```
